  ...
  Vector<DagNode*> results;
  {
    ...
    for (iter i = oc_map.begin(); i != oc_map.end(); ++i) {
      ...
      if (dn != NULL) {
        ...
        // Up op declaration
	// TODO: Maude changed upOpDecl to take symbolNr instead of pointer
	//       possibly add a copy of upOpDecl to fix this issue (OR)
	//       figure out how to get number from object
