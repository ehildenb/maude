...
MetaLevel::downSignature(DagNode* metaModule, Interpreter* owner)
{
  ...
  //	In particular, we:
  //	(1) Don't use the metalevel cache, since will hold modules created by the functional
  //	metalevl which can have the same meta-syntax but different semantics as modules
